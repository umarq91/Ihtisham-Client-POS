...
import StocksHistory from '../components/stocks/StocksHistory';
const StockHistoryPage = () => {
  let Api = `http://localhost:3000/stocks/history`;
 ...
 const [api,setApi] = useState(Api)
  ...
  const handleClick=(e)=>{
    ...
    if(search.length>0){
      ...
      setApi(`http://localhost:3000/stocks/history?name=${search}`)
    }
